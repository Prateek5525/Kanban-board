              ...
              // Dynamic rendering based on group type (status, user, priority)
              {
                ...
                'priority': (
                  <>
                    {
                      {
                        0: <div className="card-tag-icon">Low Priority</div>,
                        1: <div className="card-tag-icon">Medium Priority</div>,
                        2: <div className="card-tag-icon">High Priority</div>,
                        3: <div className="card-tag-icon">Critical</div>,
                        4: <div className="card-tag-icon">Immediate</div>
                      }[props.listTitle]
                    }
                  </>
                )
