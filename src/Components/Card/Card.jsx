        ...
        <div className="card-container">
            ...
            <div className="card-id-wrapper">
                ...
                <div className="card-profile">
                    {/* Display the first two letters of the user's name for the profile */}
                    <div className="card-profile-initial">{props.cardDetails.userObj.name[0]}{props.cardDetails.userObj.name[1]}</div>

                    {/* If user is available, apply a special class to indicate availability */}
            ...
            {/* Card Tags (Priority and custom tags) */}
            <div className="card-tag">
                {/* Render a tag icon based on the priority value */}
                {
                    {
                ...
                {/* Render any custom tags for the card */}
                {
